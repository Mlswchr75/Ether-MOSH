...
async function main() {
  ...
  if (registry.total !== 105 || registry.uniqueIds !== 105 || registry.uniqueNames !== 105) {
    console.error(`Effect registry gate failed: expected 105 total/unique IDs/unique names; received ${registry.total}/${registry.uniqueIds}/${registry.uniqueNames}.`);
    process.exitCode = 1;
    return;
  }
