...
async function main() {
  ...
  if (registry.total !== 107 || registry.uniqueIds !== 107 || registry.uniqueNames !== 107) {
    console.error(`Effect registry gate failed: expected 107 total/unique IDs/unique names; received ${registry.total}/${registry.uniqueIds}/${registry.uniqueNames}.`);
    process.exitCode = 1;
    return;
  }
