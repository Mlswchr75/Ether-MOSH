  ...
  return (
    <div className="space-y-5">
      ...
      <input
        ...
        className="w-full rounded-md border border-border/40 bg-card/40 px-3 py-2 font-mono text-xs text-foreground placeholder:text-foreground/30 focus:border-primary/50 focus:outline-none"
      />
