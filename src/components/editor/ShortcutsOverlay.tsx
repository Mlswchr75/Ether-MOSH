...
const SECTIONS: Section[] = [
  ...
  {
    name: "Touch · visualizer",
    rows: [
      { keys: ["Hold centre"], label: "Hot triggers wheel · flick to steer, release to fire" },
      { keys: ["2-finger hold"], label: "Parameters wheel · layers, FX, tune, audio" },
      { keys: ["T"], label: "Parameters wheel · keyboard" },
      { keys: ["2-finger tap"], label: "Capture screenshot" },
      { keys: ["3-finger tap"], label: "GIF · 3s" },
      { keys: ["Swipe right"], label: "Undo" },
