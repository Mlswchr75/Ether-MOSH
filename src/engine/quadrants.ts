/** Effect relationship and XY gesture helpers for the visual instrument. */
...
/**
 * Apply a drag delta to an axis. `delta` is the normalized travel fraction
 * (-1..1); half a canvas of travel sweeps the whole parameter range.
 */
