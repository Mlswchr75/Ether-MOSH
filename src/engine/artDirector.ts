...
export const LOOKS: Look[] = [
  {
    ...
    picks: { grade: ["liquidChrome", "filmicTone", "duotone", "solarize"], form: ["lensWarp", "perspectiveTilt", "zoomBlur", "emboss", "mirror"],
             accent: ["rgbShift", "bufferEcho", "chromaAberrate"], finish: ["vignette", "godRays", "filmGrain", "crtPhosphor"] },
    suits: { saturation: -0.6, contrast: 0.5, needsColor: 0.3 }, drive: 0.5,
  },
  {
    id: "neonRain", name: "NEON RAIN", blurb: "Everything traced in light.",
    picks: { grade: ["duotone", "chromaPulse", "voltage"], form: ["ripple", "liquidWarp", "displacement", "twirl"],
             accent: ["rgbShift", "shockwave", "chromaAberrate", "echoTrails"], finish: ["neonContour", "bloom", "plasmaField", "holoShine"] },
    suits: { density: 0.7, brightness: -0.5, needsLift: 0.4 }, drive: 0.65,
  },
  {
    id: "solarBloom", name: "SOLAR BLOOM", blurb: "Blown-out warmth and haze.",
    picks: { grade: ["thermal", "chromaPulse", "acrylicBleed"], form: ["zoomBlur", "lensWarp", "ripple", "perspectiveTilt"],
             accent: ["bufferEcho", "rgbShift", "pixelExplode"], finish: ["godRays", "bloom", "lightLeak", "anamorphic", "volumetricShaft"] },
  ...
  },
  {
    ...
    picks: { grade: ["prismDispersion", "oilSlick", "solarize", "anaglyph"], form: ["lensWarp", "drosteTunnel", "ripple", "glassRefract"],
             accent: ["rgbShift", "shockwave", "chromaAberrate"], finish: ["holoShine", "bloom", "dustMotes", "caustics", "anamorphic"] },
    suits: { needsColor: 0.9, saturation: -0.4 }, drive: 0.6,
  },
  {
    id: "deepVoid", name: "DEEP VOID", blurb: "Weight, shadow and drift.",
    picks: { grade: ["filmicTone", "duotone", "infraredDream", "noiseTint", "contourMap"], form: ["frameSmear", "perspectiveTilt", "melt", "strataSlice"],
             accent: ["bufferEcho", "scanFreeze", "echoTrails"], finish: ["fog", "vignette", "dustMotes", "causticWater"] },
  ...
  },
  {
    ...
    picks: { grade: ["oilSlick", "chromaPulse", "kuwahara", "acrylicBleed"], form: ["inkFlow", "melt", "liquidWarp", "flowSmear"],
             accent: ["bufferEcho", "rgbShift", "trailDecay"], finish: ["dreamGlow", "bloom", "auroraVeil", "fog"] },
  ...
  },
  {
    ...
    picks: { grade: ["liquidChrome", "filmicTone", "voltage", "contourMap", "anaglyph"], form: ["voronoiShatter", "crystalize", "kaleidoscope", "extrude", "displacement"],
  ...
  },
  {
    ...
    picks: { grade: ["infraredDream", "hueRotate", "noiseTint"], form: ["polarFold", "ripple", "liquidWarp", "flowTurbulence"],
             accent: ["bufferEcho", "scanFreeze", "echoTrails", "trailDecay"], finish: ["auroraVeil", "dreamGlow", "dustMotes", "volumetricShaft"] },
    suits: { brightness: -0.6, needsColor: 0.5, needsLift: 0.5 }, drive: 0.45,
  },
  {
    id: "vortex", name: "VORTEX", blurb: "Everything pulled to one point.",
    picks: { grade: ["oilSlick", "filmicTone", "colorQuake", "topoContour"], form: ["drosteTunnel", "twirl", "fractalZoom", "polarFold", "mandalaBloom"],
             accent: ["shockwave", "pixelExplode", "echoTrails"], finish: ["bloom", "godRays", "vignette", "volumetricShaft"] },
    suits: { needsStructure: 0.7, contrast: 0.3 }, drive: 0.8,
  },
  {
    id: "titanium", name: "TITANIUM", blurb: "Desaturated, sharp, expensive.",
    picks: { grade: ["filmicTone", "liquidChrome", "posterize", "crossHatch", "contourMap"], form: ["perspectiveTilt", "lensWarp", "mirror", "emboss"],
             accent: ["rgbShift", "jitter", "chromaAberrate"], finish: ["vignette", "filmGrain", "godRays", "crtPhosphor"] },
    suits: { saturation: -0.7, needsContrast: 0.4, density: 0.3 }, drive: 0.4,
  },
  {
    id: "infraBloom", name: "INFRA BLOOM", blurb: "Heat-mapped and glowing.",
    picks: { grade: ["thermal", "infraredDream", "topoContour"], form: ["ripple", "zoomBlur", "melt", "flowSmear"],
             accent: ["shockwave", "rgbShift", "chromaAberrate", "echoTrails"], finish: ["bloom", "dreamGlow", "lightLeak", "volumetricShaft", "emberField"] },
  ...
  },
  {
    ...
    picks: { grade: ["vhsBleed", "posterize", "bitCrush", "photocopy", "scanlines"], form: ["pixelSort", "sliceDrift", "displacement", "moire", "slitScan"],
             accent: ["datamosh", "blockShift", "compressionTears", "glitchTeleport", "staticSnow"], finish: ["filmGrain", "vignette", "fog", "crtPhosphor"] },
     ...
     painted back over. */
  {
    ...
    picks: { grade: ["filmicTone", "duotone", "liquidChrome", "anaglyph"],
             form: ["dimensionSplit", "depthShear", "volumetricPull", "pageCurl", "timeShatter"],
             accent: ["rgbShift", "shockwave", "bufferEcho", "chromaAberrate"],
             finish: ["vignette", "godRays", "anamorphic", "dustMotes"] },
  ...
  },
  {
    ...
    picks: { grade: ["filmicTone", "chromaPulse", "voltage", "topoContour"],
             form: ["timeShatter", "strataSlice", "chronoBleed", "depthShear", "flowTurbulence"],
             accent: ["jitter", "rgbShift", "scanFreeze", "rollingShutter", "timeDisplace"],
             finish: ["filmGrain", "vignette", "bloom", "anamorphic"] },
  ...
  },
  {
    ...
    picks: { grade: ["infraredDream", "thermal", "filmicTone", "anaglyph"],
             form: ["parallaxExplode", "depthEcho", "volumetricPull", "flowSmear"],
             accent: ["echoTrails", "bufferEcho", "shockwave", "motionMomentum"],
             finish: ["godRays", "dreamGlow", "anamorphic", "reactionBloom", "volumetricShaft"] },
     ...
     in particular. They exist to give the director somewhere to actually aim. */
  {
    ...
    picks: { grade: ["rainbowMap", "hueRotate", "chromaPulse", "topoContour", "acrylicBleed"],
             form: ["mandalaBloom", "kaleidoscope", "polarFold", "moirePulse", "fractalZoom"],
             accent: ["rgbShift", "chromaAberrate", "shockwave", "pixelExplode"],
             finish: ["bloom", "holoShine", "volumetricShaft", "plasmaField"] },
    suits: { needsColor: 0.8, density: 0.3 }, drive: 0.88,
  },
  {
    id: "liquidMemory", name: "LIQUID MEMORY", blurb: "Flow that remembers where it's been.",
    picks: { grade: ["filmicTone", "oilSlick", "duotone", "noiseTint"],
             form: ["flowTurbulence", "liquidWarp", "flowSmear", "inkFlow", "crystalize"],
             accent: ["echoTrails", "bufferEcho", "trailDecay", "motionMomentum"],
             finish: ["dreamGlow", "fog", "auroraVeil", "caustics"] },
  ...
  },
  {
    ...
    picks: { grade: ["hueRotate", "rainbowMap", "infraredDream", "topoContour"],
             form: ["feedbackTunnel", "drosteTunnel", "infiniteZoom", "fractalZoom", "polarFold"],
             accent: ["rgbShift", "chromaAberrate", "echoTrails"],
             finish: ["bloom", "neonContour", "dustMotes", "plasmaField", "volumetricShaft"] },
  ...
  },
  {
    ...
    picks: { grade: ["duotone", "voltage", "thermal", "crossHatch"],
             form: ["depthShear", "depthEcho", "parallaxExplode", "flowTurbulence", "timeShatter"],
             accent: ["rgbShift", "jitter", "chromaAberrate", "scanlineWarp"],
             finish: ["neonContour", "bloom", "emberField", "crtPhosphor", "volumetricShaft"] },
  ...
  },
  {
    ...
    picks: { grade: ["vhsBleed", "posterize", "bitCrush", "paletteDither", "halftone", "scanlines"],
             form: ["sliceDrift", "pixelSort", "slitScan", "moire"],
             accent: ["datamosh", "blockShift", "compressionTears", "scanBreak", "scanlineWarp", "staticSnow"],
             finish: ["crtPhosphor", "filmGrain", "vignette", "lightLeak"] },
  ...
  },
  {
    ...
    picks: { grade: ["prismDispersion", "liquidChrome", "oilSlick", "anaglyph"],
             form: ["glassRefract", "crystalize", "voronoiShatter", "twirl", "mandalaBloom"],
             accent: ["chromaAberrate", "rgbShift", "echoTrails"],
             finish: ["bloom", "caustics", "holoShine", "prismFlame"] },
  ...
  },
  {
    ...
    picks: { grade: ["chromaPulse", "voltage", "rainbowMap", "acrylicBleed"],
             form: ["mandalaBloom", "kaleidoscope", "flowTurbulence", "polarFold"],
             accent: ["shockwave", "rgbShift", "pixelExplode", "hexShatter"],
             finish: ["plasmaField", "bloom", "emberField", "volumetricShaft", "anamorphic"] },
  ...
  },
  {
    ...
    picks: { grade: ["posterize", "bitCrush", "thermal", "photocopy"],
             form: ["pixelSort", "melt", "strataSlice", "flowSmear", "sliceDrift", "depthShear"],
             accent: ["timeDisplace", "motionMomentum", "datamosh", "asciiCollapse", "glitchTeleport"],
             finish: ["filmGrain", "vignette", "fog", "reactionBloom"] },
  ...
  },
  {
    ...
    picks: { grade: ["liquidChrome", "prismDispersion", "filmicTone", "anaglyph"],
             form: ["glassRefract", "ripple", "lensWarp", "crystalize", "moirePulse"],
             accent: ["chromaAberrate", "shockwave", "bufferEcho", "hexShatter"],
             finish: ["caustics", "bloom", "dreamGlow", "anamorphic", "causticWater"] },
  ...
  },
  {
    ...
    picks: { grade: ["infraredDream", "duotone", "filmicTone", "topoContour"],
             form: ["dimensionSplit", "timeShatter", "volumetricPull", "chronoBleed", "flowSmear", "flowTurbulence"],
             accent: ["echoTrails", "chromaAberrate", "rgbShift", "motionMomentum"],
             finish: ["volumetricShaft", "emberField", "dustMotes", "reactionBloom"] },
